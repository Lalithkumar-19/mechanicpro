...
const mechanicaxiosInstance = axios.create({
    baseURL: "https://mechpro-backend-production-2953.up.railway.app/api/mechanic",//"https://mechpro-backend.vercel.app/api/mechanic",//"https://backend.mechanicpro.in/api/mechanic",
    headers: {
